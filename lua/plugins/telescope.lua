return {
  ...
  keys = {
    ...
    { "<Leader>fs", function() require("telescope.builtin").lsp_dynamic_workspace_symbols() end, desc = '[F]ind [S]ymbols' },
    { "<Leader>fb", function() require("telescope.builtin").buffers() end, desc = '[F]ind [B]uffers' },
    { "<Leader>fa", function() require("telescope.builtin").builtin() end, desc = '[F]ind [A]ll the stuff' },
